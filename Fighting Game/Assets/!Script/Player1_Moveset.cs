...
public class Player1_Moveset : MonoBehaviour
{
    //animation variable
    ...
    public void OnJump()
    {
        if (IsGrounded() == true)
        {
            ...
            ground = true;
        }else if (IsGrounded() == false) { ground = false; }
    }
    ...
    {
        PracticeMenu mm = GameObject.Find("Player 1 Menus").GetComponent<PracticeMenu>();
